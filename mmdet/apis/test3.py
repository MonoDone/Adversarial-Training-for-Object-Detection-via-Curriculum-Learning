...
def multi_gpu_test(model, data_loader, tmpdir=None, gpu_collect=False, test_adv_cfg=None, adv_load_dir="/root/anaconda3/oddefense/datasets/voc/VOCdevkit/VOC2007"):
